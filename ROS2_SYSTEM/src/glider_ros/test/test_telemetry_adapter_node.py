"""
Integration tests for TelemetryAdapterNode.

Tests are split into two classes:
    TestTelemetryBuildInternal: Internal, no ROS topics involved
    TestTelemetryPubSub: External, verifies that the node publishes expected messages
"""
import math
import threading
import time
...
from glider_ros.adapter.telemetry_adapter_node import TelemetryAdapterNode
...
def telemetry_node(rclpy_session):
    """Fresh TelemetryAdapterNode per test. No executor — internal calls only."""
