...
class CanBridgeNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('home_vbd_right', False)      #Does it exist
        self.declare_parameter('home_pr', False)             #Does it exist
    ...
    def _send_pr_cmd(self):
        #P&R CMD_SETPOINT (0x103): pitch int16 0.1mm, roll int16 0.1deg, mode byte (bit0=EN bit1=HOME), seq byte 6
    ...
    def _send_vbd_cmd(self, node_id, side):
        #VBD CMD_SETPOINT (0x101/0x102): byte0 stroke pct 0-100, byte3 mode (bit0=EN bit1=HOME), byte6 seq
    ...
    def _stop_homing(self):
        """Clear home bits while keeping enable on so actuators hold position."""
